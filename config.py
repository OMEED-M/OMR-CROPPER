...
CORNER_VERIFICATION_TOLERANCE = 50
CORNER_VERIFICATION_MIN_LINES = 1
CORNER_VERIFICATION_CIRCLE_RADIUS = 50
CORNER_VERIFICATION_CIRCLE_THICKNESS = 3
CORNER_VERIFICATION_ARROW_LENGTH = 30
CORNER_VERIFICATION_LINE_THICKNESS = 2
CORNER_VERIFICATION_TEXT_OFFSET_X = -30
CORNER_VERIFICATION_TEXT_OFFSET_Y = -20
